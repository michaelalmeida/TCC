...
level1.prototype = {
  // This is a method
  preload: function () {
    game.load.image("airplane", "assets/images/airplane.png");
    game.load.image("particle", "assets/images/particle.png");
    game.load.image("play", "assets/images/letsplay.png");
    ...
    game.load.image("hands", "assets/images/hands_congrats.png");
    game.load.spritesheet('button', 'assets/images/button.png', 300, 70);
    // volume bar
    game.load.image("vol_bar_01", "assets/images/vol_bar_01.png");
    game.load.image("vol_bar_02", "assets/images/vol_bar_02.png");
    game.load.image("vol_bar_03", "assets/images/vol_bar_03.png");
    game.load.image("vol_bar_04", "assets/images/vol_bar_04.png");
    game.load.image("vol_bar_05", "assets/images/vol_bar_05.png");
    // confete
    game.load.image("confete_blue", "assets/images/confete_blue.png");
    game.load.image("confete_yellow", "assets/images/confete_yellow.png");
    game.load.image("confete_rose", "assets/images/confete_rose.png");
  },
  create: function () {
    // Text 
